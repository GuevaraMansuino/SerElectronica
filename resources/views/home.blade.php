...
@section('meta_description',
    'Audio profesional, equipos de música y electrónica en Mendoza. Lavalle 299. Excelente
    atención y los mejores precios.')
    ...
    @push('styles')
        ...
        <style>
            ...
            .featured-section {
                ...
                /* Subimos la sección de productos destacados */
            }
        </style>
    @endpush
    ...
    <section class="hero" aria-label="Presentación">
        <div class="hero__content">
            ...
            <p class="hero__subtitle fade-up d2">
                Altavoces, amplificadores, equipos de música y tecnología. Asesoramiento personalizado y los mejores precios
                de Mendoza.
            </p>
            ...
            <div class="hero__actions fade-up d3">
                ...
                <a href="https://wa.me/5492613372353?text=Hola!+Estaba+en+su+pagina+web+y+queria+consultarles"
        ...
        <div class="hero__visual fade-up d2" aria-hidden="true">
            <div class="hero__img-frame">
                ...
                <div class="hero__img-main">
                    ...
                    <img src="{{ asset('images/ImagenLocalFuera2.png') }}" alt="Interior de SER Electrónica – Mendoza"
                        loading="eager">
                </div>
...
============================================================ --}}
    <section class="featured-section" aria-labelledby="featured-heading">
        ...
        <div class="price-notice"
            style="display:flex;align-items:center;justify-content:center;gap:0.6rem;padding:0.6rem 1rem;background:rgba(255,200,0,0.08);border:1px solid rgba(255,200,0,0.25);border-radius:var(--radius);font-size:0.85rem;color:var(--text-2);margin-bottom:1rem;text-align:center;max-width:800px;margin-left:auto;margin-right:auto;">
            <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"
                viewBox="0 0 24 24" aria-hidden="true" style="flex-shrink:0;color:#ffc800;">
                <circle cx="12" cy="12" r="10" />
                <line x1="12" y1="8" x2="12" y2="12" />
                <line x1="12" y1="16" x2="12.01" y2="16" />
            </svg>
            <span><strong>Precios de contado/transferencia</strong>. Los precios pueden variar. Son precios de lista sujetos
                a cambios sin previo aviso.</span>
        </div>
                ...
                <div class="promo-grid">
                    @foreach ($promociones->take(3) as $promo)
                        <div class="promo-card">
                            ...
                            @endif
                            <a href="{{ route('promociones.index') }}" class="btn btn-lime"
                                style="font-size:0.78rem;padding:9px 18px;">
                                Ver promoción →
                            </a>
                        </div>
                    @endforeach
        ...
        <div class="about__content">
            ...
            <div class="about__features">
                ...
                <div class="feature-item feature-item--recycle">
                    ...
                    <div class="feature-item__text">Reciclamos equipos electrónicos, pilas y baterías para cuidar el medio
                        ambiente. ¡Traenos los tuyos!</div>
                </div>
            </div>
                ...
                @php
                    ...
                    $reviews = [
                        [
                            ...
                            'date' => '2025-11-15',
                            'text' =>
                                'La atención un lujo, los productos de primera. El equipo me ayudó con todo, incluso con algo de un juego. 11/10.',
                            'rating' => 5,
                        ],
                        [
                            'name' => 'José Antonio Chaile',
                            'date' => '2025-10-20',
                            'text' =>
                                'Excelente atención y precios. Muy buena calidad en sus productos. Unos genios, los recomiendo totalmente.',
                            'rating' => 5,
                        ],
                        [
                            'name' => 'Marcos D.',
                            'date' => '2025-08-10',
                            'text' =>
                                'Hay buenas marcas en equipo de música y altavoces pasivos y activos. Excelente asesoramiento y muy buenos precios.',
                            'rating' => 5,
                        ],
                    ];
                @endphp
                        ...
                        <div class="review-card__author">
                            ...
                            <div>
                                ...
                                <div class="review-card__date">
                                    {{ \Carbon\Carbon::parse($review['date'])->diffForHumans() }}</div>
                            </div>
                        </div>
                    </article>
                @endforeach
            ...
            if (toggle && grid) {
                toggle.addEventListener('click', function() {
                    ...
                    if (grid.classList.contains('open')) {
                        toggle.innerHTML =
                            'Ocultar <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6"/></svg>';
                    } else {
                        toggle.innerHTML =
                            'Ver categorías <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6"/></svg>';
                    }
                });
            }
        })();
