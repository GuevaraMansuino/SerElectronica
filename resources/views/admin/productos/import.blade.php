    ...
    <div style="padding: 2rem;">
        ...
        <div style="margin-bottom: 1.5rem; padding: 1rem; background: var(--surface-2); border-radius: var(--radius);">
            ...
            <ul style="font-size: 0.8rem; color: var(--text-3); padding-left: 1.2rem; line-height: 1.8;">
                ...
                <li><strong>gallery:</strong> Imágenes adicionales separadas por coma (ej: foto1.jpg,foto2.jpg)</li>
            </ul>
        </div>

        <p style="font-size: 0.85rem; color: var(--text-3); margin-bottom: 2rem;">
            <a href="{{ asset('plantilla_productos.csv') }}" download style="color: var(--lime);">
                📥 Descargar plantilla de ejemplo
            </a>
        </p>

        <form action="{{ route('admin.productos.import.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
